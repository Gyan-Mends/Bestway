...
const Login = () => {
    ...
    useEffect(() => {
        if (actionData) {
            setLoading(false); // Stop loading on action data response
        ...
        <div className={`lg:grid lg:grid-cols-2 h-[100vh] dark:bg-[#191919] overflow-y-hidden bg-[#191919]`}>
            ...
            <div className="h-[100vh] w-full flex items-center justify-center ">
                <div className="dark:bg-[#333] bg-[#333] shadow-sm p-6 rounded-2xl lg:w-[30vw] border dark:border-white/5 border-white/5 relative">
                    ...
                    <Form method="post" className="mt-16" onSubmit={handleSubmit}>
                        <div>
                            <Input
                                name="email"
                                label="Email"
                        ...
                        <button
                            className={`border-b-1 border-white hover:border-white bg-success rounded-xl w-full h-10 mt-10 font-semibold font-montserrat text-white ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
                            disabled={loading}
                        >
